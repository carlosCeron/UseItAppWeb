...
namespace UseIt.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,UserID,title,ourcomment,tags")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,UserID,title,ourcomment,tags")] Comment comment)
        {
            if (ModelState.IsValid)
            {
